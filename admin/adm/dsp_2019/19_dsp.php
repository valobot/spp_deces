...
<form action="?page=prosdsp19" method="POST">
<div align="center"><center>
  <table width='600'><tr><td>
	<fieldset ><legend>INPUT DATA DSP 2019/2020</legend>
		<table border='0' width='600'>
			...
			<tr>
				<td>Jenjang</td><td>:</td>
				<td><select name='jenjang' required>
			...
			<tr>
				...
				<td><select name='jurusan' required>
						...
						<option value="ANALIS KESEHATAN">ANKES</option>
					</select>
				</td>
			</tr>
			<tr>
...
<table width="97%" border='0'>
 <tr>
	<td width='900'>
	<fieldset><legend align="center"><b>DATA PEMBAYARAN DSP T.A 2019-2020</b></legend>
	<table width="95%" border="1" align="center" cellspacing="0">
		<p style="margin-top:5px; margin-button:5px;" align="left">
			<form action="?page=cari_jjg19" method="POST" name="form1">
				Input : Jenjang
				<input name="jenjang" type="text" id="cari" size="35" placeholder='Masukkan smp/smk'>	 
		...
		$query="select * from dsp_2019 order by id_dsp19 desc limit $posisi,$batas";
	...
	<tr align="" bgcolor="#DFFDD5">
		...
		<td align="center">
			<a href="?page=editdsp19&&id_dsp19=<?php echo $data['id_dsp19']; ?>"> <img src="images/button-edit.gif" class="preview" title="Edit" width="20" height="20"></img></a> |
			<!--		
			<a href="?page=del&&id_dsp19=<?php echo $data['id_dsp19'];?>" onClick="return confirm('Apakah Anda yakin akan menghapus Data ini ?...')"><img src="images/button-cross.gif" class="preview" title="Hapus" width="20" height="20"></img></a> |
			-->
			<a href="?page=detdsp19&&id_dsp19=<?php echo $data['id_dsp19']; ?>"><img src="images/printer1.png" class="preview" title="Print" width="20" height="25"></img>
		</td>
	</tr>
	<?php 
	$no++; 
	...
	<?php		
	//=============PAGING ========================
		$sql_paging = mysqli_query("select id_dsp19 from dsp_2019");
		...
		for($i = 1; $i <= $jumlah_halaman; $i++)
			if($i != $halaman) {
				echo "<a href=?page=dsp19&&halaman=$i>&nbsp; $i &nbsp;</a><b>|</b>"; 
			} else {
				echo "<b> $i &nbsp; |</b>";
			}
		?>
		<br>
		Jumlah Siswa yang telah membayar DSP Saat ini : <?php echo $jmldata;?> Siswa.
		</fieldset>		
	   </td>
	  </tr>
	</table>

...
<body>
	<center>
		<button onclick="printContent('div1')"><b> [Catak]</b></button>
		<a href="?page=kes"><button><b>[Back]</b></button></a>
	</center>
	...
	$query = mysqli_query("select * from calonsiswa_kes where no_pendf='$no_pendf'") or die(mysqli_error());
	...
	<table width="96%" align="center">
		...
		<!-- Batas -->
		<tr>
			<td width="100%" colspan="8"><?php include "rincian_kes.php";?></td>
		</tr>
		<tr>
			<td colspan="6">

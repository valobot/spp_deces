...
<body>
	...
	$query = mysqli_query("select * from spp_smp INNER JOIN siswa ON spp_smp.id=siswa.id INNER JOIN kelas ON spp_smp.id_kelas=kelas.id_kelas where id_sppsmp='$id_sppsmp'") or die(mysqli_error());
		...
		<tr>
			<td colspan="6">
				...
				<table align="center" width="97%">
				  <tr>
					<td></td><td></td>
					<td><p style='margin-left:200px;'>No. Kwitansi</u> : <?php echo $row['id_sppsmp'];?></p></td>
				  </tr>
				 ...
				 <!--Batas-->
				  ...
				  <tr>
					<td>Kelas</td><td>:</td>
					<td bgcolor="#dad7d1"><?php echo $row['nm_kelas'];?></td>
				  </tr>
				  <tr>

...
<body>
	...
	<table border="1" width="95%" align="center">
		<tr bgcolor="#00FF66" align="center" height="40">
			...
			$dari= $_POST['dari'];
			$sampai= $_POST['sampai'];
			$q="SELECT * from spp_smp INNER JOIN siswa ON spp_smp.id=siswa.id INNER JOIN kelas ON spp_smp.id_kelas=kelas.id_kelas INNER JOIN jurusan ON spp_smp.id_jrsn=jurusan.id_jrsn where tgl between '$dari' and '$sampai' order by id_sppsmp asc";
			...
			<tr>
				...
				<td colspan="">Rp. </td>
				<td align='right'><?php $jumlahkan = "SELECT SUM(jumlah_bayar) AS total FROM spp_smp where tgl between '$dari' and '$sampai'"; 

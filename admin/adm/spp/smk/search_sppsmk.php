...
<body>
	...
	<form method="POST" action="?page=lap_priode_smk">
		<table cellpadding="2">
			<tr>
				<td>Dari</td><td>:</td>
...
<table width="1000" border='0'>
 <tr>
	<td width='400'><center>
	<fieldset><legend><strong><b>Laporan Pembayaran SPP Siswa/i SMK Tunas Bangsa Depok</b></strong></legend>
		<table width="1000" border="1" align="center" cellspacing="0">
			<p style="margin-top:5px; margin-button:5px;" align="center">
				<form action="?page=laporan_sppsmk" method="POST" name="form1">
					Input : Tgl. Transaksi hari ini
					<input name="tgl" type="text" id="cari" size="20" placeholder='Format : yyyy-mm-dd' maxlength="30">

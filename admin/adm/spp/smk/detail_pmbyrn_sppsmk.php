...
<body>
	...
	<font size="4"><b>DETAIL PEMBAYARAN SPP PER-SISWA<br>SISWA/I SMK TUNAS BANGSA DECES<br></font>
	<table border="1" width="94%" align="left">
		...
		$nama= $_POST['nama']; 
		$q = "SELECT * from spp_smk INNER JOIN siswa ON spp_smk.id=siswa.id INNER JOIN kelas ON spp_smk.id_kelas=kelas.id_kelas INNER JOIN jurusan ON spp_smk.id_jrsn=jurusan.id_jrsn where nama like '%$nama%' "; 

...
<body>
	...
	<table border="1" width="97%">
		...
		$q = "SELECT * from calonsiswa_smp where no_pendf like '%$no_pendf%' "; 
		...
		?>
			<tr>
				...
				<td align="center">					
					<a href="?page=detailsmp&&no_pendf=<?php echo $row['no_pendf']; ?>"><img src="images/button-view.gif" class="preview" title="Detail" width="20" height="20"></img></a>
				</td>
			</tr>
		<?php
		$no++;

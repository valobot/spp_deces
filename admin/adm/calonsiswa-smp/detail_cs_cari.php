...
<body>
	<center>
		<button onclick="printContent('div1')"><b> [Cetak]</b></button>
		<a href="?page=smp"><button><b>[Back]</b></button></a>
	</center>
	...
	<table width="95%" align="center">
		<tr bgcolor="" align="center">
			<td align="center"><img src="images/logo/SMPDECES.png" height="100" width="100"></td>
			...
			<font size="1" color="black">
				Jl. H. Abdul Gahni No. 75, Rt. 006 Rw. 001 Kel. Kalibaru, Kec. Cilodong Kota Depok, Telp.: 021-8755777
			</font>
			</td>
		...
		<tr height="40">
			...
			<td colspan="2" align="center"><font size='3'><?php echo "<font size='3'>".$_SESSION['userid']."</font>";?>
			</td>
		</tr>
		
		<!-- Batas -->
		<tr>
			<td width="100%" colspan="8"><?php include "rincian_smp.php";?></td>
		</tr>
		<tr>
			<td colspan="6">
				...
				<table align="center" width="90%">
				 ...
				 <table align="center" width="90%">
				  ...
				  <tr>
					<td></td><td></td>
					<td></td>
					<td><font size='5'><?php echo "<font size='3'>".$_SESSION['userid']."</font>";?></td>
				  </tr>
				</table>
				</fieldset>	
			</td>

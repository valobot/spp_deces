...
<form action="?page=prossmp" method="POST">
<div align="center"><center>
  <table width='600'><tr><td>
	<fieldset ><legend>INPUT DATA CALON SISWA SMP</legend>
...
<table width="85%" border='0'>
 <tr>
	<td width='500'><center>
	<fieldset><legend><strong><b>Tabel  Data Calon Siswa SMP</b></strong></legend>
	<table width="1300" border="1" align="center" cellspacing="0">
		...
		$query="select * from calonsiswa_smp order by no_pendf desc limit $posisi,$batas";
	...
	<tr align="" bgcolor="#DFFDD5">
		...
		<td align="center">
			<a href="?page=edit&&no_pendf=<?php echo $data['no_pendf']; ?>"> <img src="images/button-edit.gif" class="preview" title="Edit" width="20" height="20"></img></a> |
					
			<a href="?page=del&&no_pendf=<?php echo $data['no_pendf'];?>" onClick="return confirm('Apakah Anda yakin akan menghapus Data ini ?...')"><img src="images/button-cross.gif" class="preview" title="Hapus" width="20" height="20"></img></a> |
			
			<a href="?page=detailsmp&&no_pendf=<?php echo $data['no_pendf']; ?>"><img src="images/button-view.gif" class="preview" title="Detail" width="20" height="20"></img>
		</td>
	</tr>
	<?php 
	$no++; 
	...
	<?php		
	//=============PAGING ========================
		$sql_paging = mysqli_query("select no_pendf from calonsiswa_smp");
		...
		for($i = 1; $i <= $jumlah_halaman; $i++)
			if($i != $halaman) {
				echo "<a href=?page=clnsmp&&halaman=$i>&nbsp; $i &nbsp;</a><b>|</b>"; 
			} else {
				echo "<b> $i &nbsp; |</b>";
			}
		?>

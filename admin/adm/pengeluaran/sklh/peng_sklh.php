...
<form action="?page=tmbh_pengeluaran" method="POST">
<div align="center"><center>
  <table width='600'><tr><td>
	<fieldset ><legend>INPUT DATA PENGELUARAN SEKOLAH</legend>
...
<table width="1000" border='0'>
 <tr>
	<td width='400'><center>
	<fieldset><legend align='center'><strong><b>DATA PENGELUARAN SEKOLAH </b></strong></legend>
	<table width="1000" border="1" align="center" cellspacing="0">
		...
		$query="select * from pengeluaran_sklh order by id desc limit $posisi,$batas";
	...
	<tr align="" bgcolor="#DFFDD5">
		...
		<td align="center">
			<a href="?page=editsklh&&id=<?php echo $data['id']; ?>"> <img src="images/button-edit.gif" class="preview" title="Edit" width="20" height="20"></img></a> |
					
			<a href="?page=delsklh&&id=<?php echo $data['id'];?>" onClick="return confirm('Apakah Anda yakin akan menghapus Data ini ?...')"><img src="images/button-cross.gif" class="preview" title="Hapus" width="20" height="20"></img></a>
		</td>
	</tr>
	<?php 
	$no++; 
	...
	<?php		
	//=============PAGING ========================
		$sql_paging = mysqli_query("select id from pengeluaran_sklh");
		...
		for($i = 1; $i <= $jumlah_halaman; $i++)
			if($i != $halaman) {
				echo "<a href=?page=sklh&&halaman=$i>&nbsp; $i &nbsp;</a><b>|</b>"; 
			} else {
				echo "<b> $i &nbsp; |</b>";
			}
		?>

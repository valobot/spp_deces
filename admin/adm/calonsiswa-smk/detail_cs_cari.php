...
<body>
	<center>
		...
		<a href="?page=smk"><button><b>[Back]</b></button></a>
	</center>
	...
	$query = mysql_query("select * from calonsiswa_smk where no_pendf='$no_pendf'") or die(mysql_error());
	...
	<table width="96%" align="center">
		...
		<!-- Batas -->
		<tr>
			<td width="100%" colspan="8"><?php include "rincian_smk.php";?></td>
		</tr>
		<tr>
			<td colspan="6">
				...
				<table align="center" width="90%">
				 ...
				 <table align="center" width="90%">
				  ...
				  <tr>
					<td></td><td></td>
					<td></td>
					<td><?php echo "<font size='3'>".$_SESSION['userid']."</font>";?></td>
				  </tr>
				</table>
				</fieldset>	
			</td>

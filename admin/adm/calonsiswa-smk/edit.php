<?php  
	...
	$sql = mysqli_query("select * from calonsiswa_smk where no_pendf = '$no_pendf'") or die(mysqli_error()); 
...
<?php 
	...
	$hasil=mysqli_query("update calonsiswa_smk set no_pendf='$no_pendf', tgl_pendf='$tgl_pendf', nm_siswa='$nm_siswa', tmp_lhr='$tmp_lhr', tgl_lhr='$tgl_lhr', jk='$jk', alamat='$alamat', telp='$telp', asal_sekolah='$asal_sekolah', jurusan='$jurusan', biaya='$biaya', pendaftar='$pendaftar', ket='$ket' where  no_pendf='$no_pendf'");
	if ($hasil) {
		?>
		<script type="text/javascript">
		
		window.location.href="?page=smk";
		</script>
		<?php
	} else {
		echo mysqli_error();
...
?>
  <table width='70%'  bgcolor="#57e7a5"><tr><td>
    <fieldset ><legend><h2>EDIT DATA TEKNOLOGI</h2></legend>
	...
	<form action="" method="post">
		<table width="" align="center">
			...
			<tr>
				...
				<a href="?page=smk"><font size="4" color="blue"><b>[Back]</b></font></a></td>
			</tr>
		</table>
	</form>

...
<form action="?page=prosdsp" method="POST">
<div align="center"><center>
  <table width='600'><tr><td>
	<fieldset ><legend>INPUT DATA DSP</legend>
		<table border='0' width='600'>
			<tr>
				<td width='160'>No. Kwitansi</td><td>:</td>
				<td><input type=number name=id_dsp></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><select name='jurusan' required>
						...
						<option value="SMK-MM">SMK-MM</option>
						<option value="SMK-AKUNTANSI">SMK-AKUNTANSI</option>
						<option value="SMK-TKR">SMK-TKR</option>
...
<table width="97%" border='0'>
 <tr>
	<td width='900'><center>
	<fieldset><legend><strong><b>Tabel DSP Calon Siswa </b></strong></legend>
	<table width="95%" border="1" align="center" cellspacing="0">
		<p style="margin-top:5px; margin-button:5px;" align="left">
			<form action="?page=ddcs" method="POST" name="form1">
				Input : Calon Siswa/i
		...
		$query="select * from dsp order by id_dsp desc limit $posisi,$batas";
	...
	<tr align="" bgcolor="#DFFDD5">
		...
		<td align="center">
			<a href="?page=editdsp&&id_dsp=<?php echo $data['id_dsp']; ?>"> <img src="images/button-edit.gif" class="preview" title="Edit" width="20" height="20"></img></a> |
			<!--		
			<a href="?page=del&&id_dsp=<?php echo $data['id_dsp'];?>" onClick="return confirm('Apakah Anda yakin akan menghapus Data ini ?...')"><img src="images/button-cross.gif" class="preview" title="Hapus" width="20" height="20"></img></a> |
			-->
			<a href="?page=detdsp&&id_dsp=<?php echo $data['id_dsp']; ?>"><img src="images/printer1.png" class="preview" title="Print" width="20" height="25"></img>
		</td>
	</tr>
	<?php 
	$no++; 
	...
	<?php		
	//=============PAGING ========================
		$sql_paging = mysqli_query("select id_dsp from dsp");
		...
		for($i = 1; $i <= $jumlah_halaman; $i++)
			if($i != $halaman) {
				echo "<a href=?page=dsp&&halaman=$i>&nbsp; $i &nbsp;</a><b>|</b>"; 
			} else {
				echo "<b> $i &nbsp; |</b>";
			}
		?>

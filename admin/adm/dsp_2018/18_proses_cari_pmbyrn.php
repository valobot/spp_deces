...
<body>
	...
	<table align="center" width="95%">
		<tr>
			<td align="left">
				...
				CALON SISWA/I SMP & SMK 2018/2019 TUNAS BANGSA CILODONG (DECES)</font>
			</td>
		</tr>
	</table>
	<table border="1" width="95%" style='font-size:12.5px;'>
		...
		$q = "SELECT * from dsp_2018 where tgl_pmbyrn like '%$tgl_pmbyrn%' "; 
	...
	<?php include "18_mengetahui-dsp.php"; ?>
	</div>
</body>
</html>
...
<body>
	...
	<table border="1" width="95%" align="center">
		<tr bgcolor="#00FF66" align="center" height="40">
			...
			$dari= $_POST['dari'];
			$sampai= $_POST['sampai'];
			$q="SELECT * from dsp where tgl_pmbyrn between '$dari' and '$sampai' order by id_dsp asc";
			...
			<tr>
				...
				<td align=""><?php echo $data -> nm_siswa;?></td>
			...
			<tr>
				...
				<td colspan="">Rp. </td>
				<td align='right'><?php $jumlahkan = "SELECT SUM(jumlah) AS total FROM dsp where tgl_pmbyrn between '$dari' and '$sampai'"; 

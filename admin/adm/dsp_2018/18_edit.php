<html>
<head>
	<title>Edit DSP 2018-2019</title>
</head>
<body>
	<?php 
		include "dt/koneksi.php";
		$query=mysqli_query("SELECT * FROM dsp_2018 WHERE id_dsp18='".$_GET['id_dsp18']."'");
		$data=mysqli_fetch_array($query); 
	?>
	<form action="?page=proseditdsp18" enctype="multipart/form-data" method="post" name="postform">
	<input type="hidden" name="id_dsp18" value="<?php echo $data['id_dsp18'];?>" />
	
	<table width='80%'><tr><td>
	<fieldset ><legend style='color:blue; font: 18px Cambria, verdana, sans-serif; font-weight: bold; margin-left:20px;'>DSP 2018-2019</legend>
	<table width="75%" align="center">
		...
		<tr>
			<td colspan="3" align="center">
				...
				<a href="?page=dsp18"><font size="4" color="blue" style="border: 2px double gray; background:white;"> &nbsp; Back &nbsp;</font></a></td>
		</tr>
	</table>
	</fieldset>
    </td>

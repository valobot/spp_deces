...
<form action="?page=prostungsmk" method="POST">
<div align="center">
  <table width='600'><tr><td>
	<fieldset ><legend>INPUT TUNGGAKAN SMK</legend>
		<table border='0' width='600'>
			...
			<tr>
				...
				<td><select name='jenis_tunggak' required>
			...
			<tr>
				<td>Jumlah</td><td>:</td>
				<td><input size='16' type='text' name='jumlah' value="<?php echo $row['jumlah']; ?>"></td>
			</tr>
			<tr>
			...
			<tr>
				<td></td>
				<td colspan='3'><input type=submit value='Simpan' name='simpan'><button><a href="?page=tungsmk"><button>Batal</button></a></td>
			</tr>
			<?php 
			$no++; } ?>
		</table>

...
<body>
	...
	<table border="1" width="95%" align="center">
		<tr bgcolor="#00FF66" align="center" height="40">
			...
			$q = "SELECT * from tgsmk INNER JOIN siswa ON tgsmk.id=siswa.id INNER JOIN kelas ON tgsmk.id_kelas=kelas.id_kelas INNER JOIN jurusan ON tgsmk.id_jrsn=jurusan.id_jrsn where jenis_tunggak like '%$jenis_tunggak%'";
			...
			<tr>
				...
				<td width='130' align='right'>Rp. <?php $jumlahkan = "SELECT (jumlah) AS total FROM tgsmk where jenis_tunggak like '%$jenis_tunggak%'"; 

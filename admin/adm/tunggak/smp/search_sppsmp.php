...
<body>
	...
	<form method="POST" action="?page=lap_priode_smp">
		<table cellpadding="2">
			<tr>
				<td>Dari</td><td>:</td>
...
<table width="1000" border='0'>
 <tr>
	<td width='400'><center>
	<fieldset><legend><strong><b>Laporan Pembayaran SPP Siswa/i SMP Tunas Bangsa Depok</b></strong></legend>
		<table width="1000" border="1" align="center" cellspacing="0">
			<p style="margin-top:5px; margin-button:5px;" align="center">
				<form action="?page=laporan_sppsmp" method="POST" name="form1">

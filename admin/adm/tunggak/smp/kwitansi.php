...
<body>
	...
	$query = mysql_query("select * from spp_smp INNER JOIN siswa ON spp_smp.id=siswa.id INNER JOIN kelas ON spp_smp.id_kelas=kelas.id_kelas where id_sppsmp='$id_sppsmp'") or die(mysql_error());

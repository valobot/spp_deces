...
<form action="?page=prosppsmp" method="POST">
<div align="center">
  <table width='600'><tr><td>
	<fieldset ><legend>INPUT PEMBAYARAN SPP SMP</legend>
		<table border='0' width='600'>
			...
			<tr>
				<td>Harga</td><td>:</td>
				<td><input type='text' name='harga' value="475000"></td>
			</tr>
			<tr>
				<td>Dibayar</td><td>:</td>
			...
			<tr>
				<td></td>
				<td colspan='3'><input type=submit value='Simpan' name='simpan'>
				<a href="?page=sppsmp"><button>Batal</button></td>
			</tr>
			<?php 
			$no++; } ?>
		</table>

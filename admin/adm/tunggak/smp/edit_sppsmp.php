<?php  
	...
	$sql = mysql_query("select * from spp_smp where id_sppsmp='$id_sppsmp'") or die(mysql_error()); //memilih data
...
<?php 
	...
	$hasil=mysql_query("update spp_smp set id='$id', id_kelas='$id_kelas', id_jrsn='$id_jrsn', jenis_bayar='$jenis_bayar', harga='$harga', jumlah_bayar='$jumlah_bayar', total='$total', terbilang='$terbilang', ket='$ket' where id_sppsmp='$id_sppsmp'");
	if ($hasil) {
		?>

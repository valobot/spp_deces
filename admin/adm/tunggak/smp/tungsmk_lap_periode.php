...
<body>
	...
	<table border="1" width="95%" align="center">
		<tr bgcolor="#00FF66" align="center" height="40">
			...
			$dari= $_POST['dari'];
			$sampai= $_POST['sampai'];
			$q = "SELECT * from tgsmk INNER JOIN siswa ON tgsmk.id=siswa.id INNER JOIN kelas ON tgsmk.id_kelas=kelas.id_kelas INNER JOIN jurusan ON tgsmk.id_jrsn=jurusan.id_jrsn where tgl between '$dari' and '$sampai' order by id_tungsmk asc ";
			...
			<tr>
				...
				<td width='130' align='right'>Rp. <?php $jumlahkan = "SELECT SUM(jumlah) AS total FROM tgsmk where tgl between '$dari' and '$sampai'"; 
